...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "helperCorruptTip": MessageLookupByLibrary.simpleMessage(
      "Helper 服务不可用，无法启用 TUN 模式，请重新安装 Tunnio。",
    ),
    ...
    "vpnAndroidHelp": MessageLookupByLibrary.simpleMessage(
      "点击断开连接并等待显示已断开。关闭应用不会断开 VPN。如果 Android 不断重启 VPN，请在 Android 设置 → VPN → Tunnio 中关闭始终开启 VPN。“阻止未使用 VPN 的连接”可能会在断开后阻止上网。Android 的始终开启警告与本应用的连接通知不同。",
    ),
    ...
    "vpnImportActivating": MessageLookupByLibrary.simpleMessage("正在应用配置…请稍候。"),
    ...
    "vpnReplaceSafety": MessageLookupByLibrary.simpleMessage(
      "替换失败时会保留已保存的配置。成功应用新配置时，VPN 流量可能会短暂中断。",
    ),
